...
INDIR="/discover/nobackup/tcolliga/ED_DGVM/LUH2_MERRA2_driven"
OUTDIR="/discover/nobackup/projects/gmao/geos_carb/embell/ilamb/data/ILAMB_sample/MODELS/ED_DGVM"
